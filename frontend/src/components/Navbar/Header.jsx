...
import customLogo from '../../assests/images/campulse.png';
    ...
    <nav className="fixed top-0 w-full border-b bg-white z-10">
      ...
      <div className="flex flex-row justify-between items-center py-2 px-3.5 sm:w-full sm:py-2 sm:px-4 md:w-full md:py-2 md:px-6 xl:w-4/6 xl:py-3 xl:px-8 mx-auto">
        ...
        <Link to="/">
          <img
            draggable="false"
            className="mt-1.5 w-8 h-8 object-contain"
            src={customLogo} // Use your custom logo
            alt="Custom Logo"
          />
        </Link>
        <SearchBox />
          ...
          {user ? (
            ...
            >
              <img
                ...
                src={
                  user.avatar
                    ? BASE_PROFILE_IMAGE_URL + user.avatar
                    : customLogo
                }
                alt="Profile Avatar"
              />
